...
then
    echo "Edit Mode"
    cp /yanqing/convert.sh /workspace/run.sh
    chmod +x /workspace/run.sh
    cp /yanqing/convert_save.sh /workspace/save.sh
    ...
    echo "Run Mode"
    bash -c "${SP_DISTRIBUTED_CMD} python /yanqing/run.py components.docker.SPConvertLab.SPConvertLab"
fi
