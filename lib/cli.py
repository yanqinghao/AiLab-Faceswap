...
class ScriptExecutor:
    ...
    def import_script(self):
        ...
        self.test_for_gui()
        cmd = self.command
        src = "tools" if cmd in ["sort"] else "scripts"
    ...
    def test_for_tf_version():
        ...
        try:
            ...
            raise FaceswapError(
                "There was an error importing Tensorflow. This is most likely "
        ...
        if tf_ver < min_ver:
            raise FaceswapError(
                "The minimum supported Tensorflow is version {} but you have "
        ...
        if tf_ver > max_ver:
            raise FaceswapError(
                "The maximumum supported Tensorflow is version {} but you have "
    ...
    def execute_script(self, arguments):
        ...
        try:
            ...
            logger.info(
                "To get more information on this error see the crash report written to "
                "'%s'",
                crash_file,
            )
...
class Slider(argparse.Action):  # pylint: disable=too-few-public-methods
    ...
    def __init__(
        self, option_strings, dest, nargs=None, min_max=None, rounding=None, **kwargs
    ):
        if nargs is not None:
            raise ValueError("nargs not allowed")
        super().__init__(option_strings, dest, **kwargs)
...
class ContextFullPaths(FileFullPaths):
    ...
    def __init__(
        ...
        **kwargs
        ...
        if nargs is not None:
            raise ValueError("nargs not allowed")
        super(ContextFullPaths, self).__init__(
            option_strings, dest, filetypes=None, **kwargs
        )
